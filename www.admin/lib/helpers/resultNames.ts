...
export function getGroupedResultName(groupedResult: GroupedResult, t: ReturnType<typeof useT>, showPlacement?: boolean, showStage?: boolean) {
    let resultName = "";
...
export function getGroupedResultNameWithCount(groupedResult: GroupedResult, t: ReturnType<typeof useT>, showPlacement?: boolean) {
    const resultCount = groupedResult.results?.length ?? 0;
...
export function getOnlyResultName(result: Result, t: ReturnType<typeof useT>, stageNumberIsPrefix: boolean = true) {
