...
export default function MobileNav({
    ...
    return (
        <div className="lg:hidden">
            ...
            <div className={`${showNav ? "right-0" : "-right-full"} max-w-[90vw] sm:w-md text-end overflow-y-auto top-[2.82rem] sm:top-[3.35rem] duration-150 absolute lg:hidden bg-white h-[calc(100vh-2.81rem)] sm:h-[calc(100vh-3.35rem)] px-3 sm:px-16 pt-2 items-end flex flex-col z-10`}>
            ...
            <div className={`${showNav ? "left-0" : "left-full"} top-[2.82rem] sm:top-[3.35rem] absolute lg:hidden`}>
                <div 
